...
|---|---|---|---|---|---|
| C001 | Gust ≥45 km/h | Window `R` | weather safety / 1 | implemented by safety policy / P01-T06 | A01 / S04,S09 |
| C002 | Light rain, low gust, full geometric protection | `O` with thermal need, else `M` | weather safety / 1 | implemented as protected tilt-only / P01-T06 | A01 / S04,S09 |
| C003 | Rain with partial/no sufficient protection | `O` only for protected tilt plus need, else `R` | weather safety / 1 | implemented by safety policy / P01-T06 | A01 / S04,S09 |
| C004 | Worst current/mean wind direction and continuous façade limit | Window `A`, `O`, or `R` | weather safety / 1 | implemented by safety policy / P01-T06 | A05 / S09,S12 |
| C005 | Cold context near upper limit with adverse outside/solar balance | Window `F` | thermal / 3 | optimizer action mapped to typed output / P01-T04,P01-T06 | A01 / S06,S07 |
| C006 | Heat context near lower limit, outside ≥0.5 °C colder | Window `H` | thermal / 3 | optimizer action mapped to typed output / P01-T04,P01-T06 | A01 / S06,S10 |
| C007 | Window `A` or `O` | Blind `V`, 100% open | airflow/thermal / 2 | optimizer blind preserved by policy / P01-T04,P01-T06 | A03 / S04 |
